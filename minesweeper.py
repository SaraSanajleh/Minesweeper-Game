...
class Sentence():
    ...
    def known_mines(self):
        ...
        """
        # Restriction: The implementation should not modify self.cells
        mines = set()
...
class MinesweeperAI():
    ...
    def add_knowledge(self, cell, count):
        ...
        new_cells = new_cells - self.safes - self.moves_made  # Exclude known safes and moves made
        ...
        # 5) Add new sentences to the AI's knowledge base
        new_knowledge = []
    ...
    def get_neighbors(self, cell):
        ...
        """
        i, j = cell
        neighbors = {(i + x, j + y) for x in range(-1, 2) for y in range(-1, 2)
                     if 0 <= i + x < self.height and 0 <= j + y < self.width and (x, y) != (0, 0)}
        return neighbors
